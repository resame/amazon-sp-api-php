...
class DirectOrdersApi
{
     ...
     * Operation getOrder.
     *
     * @param string $purchaseOrderNumber An Amazon-defined order identifier, in 3-7-7 format. (required)
     *
     ...
     *
     * @param string $purchaseOrderNumberAn Amazon-defined order identifier, in 3-7-7 format. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
    ...
    protected function getOrderRequest($order_id)
    {
        ...
        $resourcePath = '/vendor/directFulfillment/orders/v1/purchaseOrders/{orderId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
